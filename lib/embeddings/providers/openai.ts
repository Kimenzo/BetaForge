...
export class OpenAIEmbeddingProvider {
  ...
  getDimensions(): number {
    return this.config.dimensions || MODEL_DIMENSIONS[this.config.model!] || 1536;
  }
...
export function createOpenAIProvider(config?: Partial<OpenAIEmbedConfig>): OpenAIEmbeddingProvider {
