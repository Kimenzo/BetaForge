...
export function generateCursorPath(
  ...
  for (let i = 0; i <= numPoints; i++) {
    const t = i / numPoints;
    const point = cubicBezier(t, start, controlPoints[0], controlPoints[1], end);
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        element: { selector: "input[type='email']", tagName: "INPUT", placeholder: "Email" },
      ...
      },
      {
        ...
        element: { selector: "input[type='password']", tagName: "INPUT", placeholder: "Password" },
      ...
      },
      {
        ...
        element: { selector: "button[type='submit']", tagName: "BUTTON", text: "Submit" },
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        element: { selector: "[role='button']", tagName: "DIV", ariaLabel: "Menu button" },
      ...
      },
      {
        ...
        element: { selector: "img", tagName: "IMG", ariaLabel: "Product image" },
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        duration: 300,
        position: { x: 350, y: 30 },
        element: { selector: ".hamburger-menu", tagName: "BUTTON", ariaLabel: "Menu" },
  ...
  for (const scenario of scenarios) {
    for (const baseAction of scenario.actions) {
      const action: SimulationAction = {
        ...
        id: generateId(),
        timestamp: currentTime,
        duration: adjustDurationForBehavior(baseAction.duration, baseAction.type, behavior),
      };
 ...
 */
export function calculateSequenceDuration(sequence: SimulationSequence): number {
...
export function getActionAtTime(
  ...
  for (let i = sequence.actions.length - 1; i >= 0; i--) {
    ...
    if (time >= action.timestamp && time <= action.timestamp + action.duration) {
      return action;
    }
  }
  return null;
