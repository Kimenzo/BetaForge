      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-500">
            Our multi-agent system covers every aspect of your application, from
            UI interactions to security vulnerabilities.
          </p>
        </div>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="mb-auto">
                ...
                <p className="text-gray-500 text-lg max-w-md">
                  Each agent has a unique persona and testing strategy. They
                  coordinate to cover more ground than any human team.
                </p>
              </div>
              ...
              <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 gap-4">
                {AGENTS.slice(0, 6).map((agent, i) => (
                  <div
                    key={agent.id}
                    className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:scale-105 hover:shadow-md transition-all duration-300 cursor-default"
                  >
                    <div
            ...
            <div className="relative z-10">
              ...
              <div className="font-mono text-xs space-y-2 text-green-400 opacity-80 group-hover:opacity-100 transition-opacity">
                ...
                <p className="text-blue-400">
                  {" "}
                  {">"} marcus: performance_check_passed (12ms)
                </p>
                <p className="text-red-400">
                  {" "}
                  {">"} diego: injection_attempt_blocked 🛡️
                </p>
