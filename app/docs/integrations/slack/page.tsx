...
export default function SlackIntegrationPage() {
  const [activeExample, setActiveExample] = useState<"bugFound" | "sessionComplete" | "criticalAlert">("bugFound");
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-start gap-6 mb-12">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-2 py-1 text-xs bg-quantum-green/20 text-quantum-green rounded-full">Popular</span>
              </div>
              <p className="text-lg text-phantom-gray mb-6">
                Get instant notifications in your team&apos;s Slack channels when tests complete, 
                bugs are found, or critical issues require attention.
              </p>
              <div className="flex items-center gap-4">
                <Link
                  href="/settings/api"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              ...
              <h3 className="font-semibold text-ghost-white text-sm">Real-time Alerts</h3>
              <p className="text-xs text-phantom-gray">Instant bug notifications</p>
            </div>
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              <Filter className="w-6 h-6 text-[#36C5F0] mb-2" />
              <h3 className="font-semibold text-ghost-white text-sm">Smart Filtering</h3>
              <p className="text-xs text-phantom-gray">By severity or project</p>
            </div>
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              <Hash className="w-6 h-6 text-[#2EB67D] mb-2" />
              <h3 className="font-semibold text-ghost-white text-sm">Channel Routing</h3>
              <p className="text-xs text-phantom-gray">Route to specific channels</p>
            </div>
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              <AtSign className="w-6 h-6 text-[#ECB22E] mb-2" />
              <h3 className="font-semibold text-ghost-white text-sm">User Mentions</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-ghost-white">Option 1: Built-in Integration</h3>
              </div>
              <p className="text-sm text-phantom-gray mb-6">
                The easiest way - connect directly from BetaForge settings with OAuth.
              </p>
              <ol className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-phantom-gray">Click &quot;Connect to Slack&quot;</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-phantom-gray">Authorize BetaForge in your workspace</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-phantom-gray">Select channels and notification preferences</span>
                </li>
              </ol>
            </div>
            ...
            <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-ghost-white">Option 2: Incoming Webhook</h3>
              </div>
              <p className="text-sm text-phantom-gray mb-6">
                More control - use Slack&apos;s Incoming Webhooks with our webhook events.
              </p>
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-neural/20 text-neural-bright flex items-center justify-center text-xs font-bold flex-shrink-0">1</span>
                  <span className="text-sm text-phantom-gray">Create an <a href="https://api.slack.com/messaging/webhooks" target="_blank" rel="noopener noreferrer" className="text-neural-bright hover:underline">Incoming Webhook</a> in Slack</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-neural/20 text-neural-bright flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
                  <span className="text-sm text-phantom-gray">Set up a <Link href="/docs/integrations/webhooks" className="text-neural-bright hover:underline">BetaForge webhook</Link> to your server</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-neural/20 text-neural-bright flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
                  <span className="text-sm text-phantom-gray">Forward events to Slack with custom formatting</span>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              {[
                ...
                { id: "sessionComplete", label: "Session Complete", icon: CheckCircle2 },
                ...
                >
                  <tab.icon className={`w-5 h-5 ${activeExample === tab.id ? "text-[#E01E5A]" : "text-phantom-gray"}`} />
                  <span className={activeExample === tab.id ? "text-ghost-white" : "text-phantom-gray"}>
                    {tab.label}
                  </span>
                </button>
              ))}
            ...
            <div className="lg:col-span-2">
              <div className="bg-[#1a1d21] rounded-xl overflow-hidden border border-[#3f4145]">
                <div className="px-4 py-3 border-b border-[#3f4145] flex items-center gap-2">
                  ...
                  <span className="text-[#9a9b9e] text-sm">betaforge-alerts</span>
                </div>
                <div className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-bold text-white text-sm">BetaForge</span>
                        <span className="px-1.5 py-0.5 text-xs bg-[#4A154B] text-white rounded">APP</span>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/5 bg-void-black/50">
                  <th className="text-left px-4 py-3 text-sm font-medium text-phantom-gray">Setting</th>
                  <th className="text-left px-4 py-3 text-sm font-medium text-phantom-gray">Description</th>
                  <th className="text-left px-4 py-3 text-sm font-medium text-phantom-gray">Default</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { name: "Channel", desc: "Which Slack channel to post to", default: "#betaforge" },
                  { name: "Notify on bug found", desc: "Send message for each bug discovered", default: "High & Critical only" },
                  { name: "Notify on session complete", desc: "Summary when all agents finish", default: "Enabled" },
                  { name: "Notify on session failed", desc: "Alert when tests fail to run", default: "Enabled" },
                  { name: "Include screenshots", desc: "Attach bug screenshots to messages", default: "Enabled" },
                  { name: "Mention users", desc: "@ mention specific users for critical bugs", default: "Disabled" },
                  { name: "Quiet hours", desc: "Suppress non-critical alerts during specified hours", default: "None" },
                ].map((setting, i, arr) => (
                  <tr key={setting.name} className={i < arr.length - 1 ? "border-b border-white/5" : ""}>
                    <td className="px-4 py-3">
                      <span className="text-sm text-ghost-white font-medium">{setting.name}</span>
                    </td>
                    <td className="px-4 py-3">
                      <span className="text-sm text-phantom-gray">{setting.desc}</span>
                    </td>
                    <td className="px-4 py-3">
                      <code className="text-xs text-electric-cyan">{setting.default}</code>
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      <section className="relative py-12 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-phantom-gray mb-6">
            For advanced use cases, you can build a custom integration using BetaForge webhooks and Slack&apos;s Block Kit.
          </p>
          ...
          <div className="bg-void-elevated border border-white/5 rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-void-black/50">
              <span className="text-sm text-phantom-gray font-mono">slack-notifier.js</span>
              <button
