...
const fieldMappings = [
  { betaforge: "title", jira: "summary", description: "Bug title becomes issue summary" },
  { betaforge: "description", jira: "description", description: "Full description with ADF formatting" },
  { betaforge: "severity", jira: "priority", description: "Critical→Highest, High→High, etc." },
  { betaforge: "agentName", jira: "labels", description: "Added as a label (e.g., 'diego-chaos-tester')" },
  { betaforge: "sessionId", jira: "customfield_*", description: "Linked to custom field if configured" },
  { betaforge: "url", jira: "customfield_*", description: "Page URL stored in custom field" },
  { betaforge: "screenshots", jira: "attachments", description: "Uploaded as issue attachments" },
  { betaforge: "stepsToReproduce", jira: "description", description: "Formatted as numbered list in description" },
];
    ...
    <div className="min-h-screen bg-void-black">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-start gap-6 mb-12">
            <div className="p-4 rounded-2xl bg-[#0052CC] border border-[#0747A6]">
              <svg className="w-10 h-10 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M5.024 5.77v6.744H16.24a5.215 5.215 0 0 0 5.232-5.215V5.027a1.005 1.005 0 0 0-1.005-1.004H6.029A1.005 1.005 0 0 0 5.024 5.77z" opacity=".65"/>
                <path d="M10.81 0v5.77h11.69a1.005 1.005 0 0 0 1.005-1.005V0H10.81z" opacity=".4"/>
              </svg>
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-4xl font-bold text-ghost-white">Jira</h1>
                <span className="px-2 py-1 text-xs bg-neural/20 text-neural-bright rounded-full">Popular</span>
              </div>
              <p className="text-lg text-phantom-gray mb-6">
                Automatically create and sync Jira issues from BetaForge bug reports. 
                Two-way sync keeps your development team aligned.
              </p>
              <div className="flex items-center gap-4">
                <Link
                  href="/settings/api"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              ...
              <h3 className="font-semibold text-ghost-white text-sm">Two-Way Sync</h3>
              <p className="text-xs text-phantom-gray">Status synced both ways</p>
            </div>
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              <Filter className="w-6 h-6 text-[#36B37E] mb-2" />
              <h3 className="font-semibold text-ghost-white text-sm">Smart Dedup</h3>
              <p className="text-xs text-phantom-gray">Prevents duplicate issues</p>
            </div>
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              <Tag className="w-6 h-6 text-[#6554C0] mb-2" />
              <h3 className="font-semibold text-ghost-white text-sm">Auto Labels</h3>
              <p className="text-xs text-phantom-gray">Severity, agent, category</p>
            </div>
            <div className="p-4 bg-void-elevated border border-white/5 rounded-xl">
              <Link2 className="w-6 h-6 text-[#FF5630] mb-2" />
              <h3 className="font-semibold text-ghost-white text-sm">Deep Links</h3>
              <p className="text-xs text-phantom-gray">Jump to BetaForge reports</p>
            </div>
          </div>
        </div>
      </section>
          ...
          {activeTab === "cloud" ? (
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-ghost-white">OAuth 2.0 (Recommended)</h3>
                </div>
                ...
                <ol className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-phantom-gray">Go to <Link href="/settings/api" className="text-neural-bright hover:underline">Settings → Integrations</Link></span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-phantom-gray">Click &quot;Connect Jira Cloud&quot;</span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-phantom-gray">Authorize BetaForge in Atlassian</span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-phantom-gray">Select projects to sync</span>
                  </li>
                </ol>
              </div>
              ...
              <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-ghost-white">API Token</h3>
                </div>
                <p className="text-sm text-phantom-gray mb-6">
                ...
                <ol className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-phantom-gray">
                      Create an <a href="https://id.atlassian.com/manage-profile/security/api-tokens" target="_blank" rel="noopener noreferrer" className="text-neural-bright hover:underline">API token</a>
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-neural/20 text-neural-bright flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
                    <span className="text-sm text-phantom-gray">Enter your Atlassian email and token in Settings</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-neural/20 text-neural-bright flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
                    <span className="text-sm text-phantom-gray">Provide your site URL (e.g., yourcompany.atlassian.net)</span>
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-ghost-white">Jira Server / Data Center</h3>
              </div>
              <p className="text-sm text-phantom-gray mb-6">
                For on-premise Jira installations. Requires network access to your Jira server.
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-sm font-medium text-ghost-white mb-3">Requirements:</h4>
                ...
                <div>
                  <h4 className="text-sm font-medium text-ghost-white mb-3">Setup steps:</h4>
              ...
              <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                <p className="text-xs text-yellow-400">
                  <strong>Enterprise plan required</strong> for Jira Server/Data Center integration.
                </p>
              </div>
            </div>
          )}
      ...
      <section className="relative py-12 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-phantom-gray mb-6">
            BetaForge automatically maps bug report fields to Jira issue fields. Custom field mappings can be configured in Settings.
          </p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/5 bg-void-black/50">
                  <th className="text-left px-4 py-3 text-sm font-medium text-phantom-gray">BetaForge Field</th>
                  <th className="text-left px-4 py-3 text-sm font-medium text-phantom-gray">Jira Field</th>
                  <th className="text-left px-4 py-3 text-sm font-medium text-phantom-gray">Notes</th>
                </tr>
              </thead>
              <tbody>
                {fieldMappings.map((mapping, i, arr) => (
                  <tr key={mapping.betaforge} className={i < arr.length - 1 ? "border-b border-white/5" : ""}>
                    <td className="px-4 py-3">
                      <code className="text-xs bg-neural/20 text-neural-bright px-2 py-1 rounded">{mapping.betaforge}</code>
                    </td>
                    <td className="px-4 py-3">
                      <code className="text-xs bg-[#0052CC]/20 text-[#4C9AFF] px-2 py-1 rounded">{mapping.jira}</code>
                    </td>
                    <td className="px-4 py-3">
                      <span className="text-sm text-phantom-gray">{mapping.description}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
              ...
              <h3 className="text-lg font-semibold text-ghost-white mb-2">Two-Way Status Sync</h3>
              <p className="text-sm text-phantom-gray mb-4">
                When a Jira issue is marked &quot;Done&quot;, the corresponding bug in BetaForge is marked as resolved.
              </p>
            ...
            <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
              ...
              <h3 className="text-lg font-semibold text-ghost-white mb-2">Smart Deduplication</h3>
              <p className="text-sm text-phantom-gray mb-4">
                Before creating an issue, BetaForge searches for existing issues with similar titles to prevent duplicates.
              </p>
              <div className="text-xs text-phantom-gray">
            ...
            <div className="p-6 bg-void-elevated border border-white/5 rounded-xl">
              ...
              <h3 className="text-lg font-semibold text-ghost-white mb-2">Comment Sync</h3>
              <p className="text-sm text-phantom-gray mb-4">
                Comments added in Jira appear in BetaForge, and vice versa. Great for collaboration between QA and dev.
              </p>
              <div className="text-xs text-phantom-gray">
      ...
      <section className="relative py-12 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-phantom-gray mb-6">
            When BetaForge creates a Jira issue, it uses Atlassian Document Format (ADF) for rich descriptions with proper formatting.
          </p>
          ...
          <div className="bg-void-elevated border border-white/5 rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-void-black/50">
              <span className="text-sm text-phantom-gray font-mono">jira-issue-payload.json</span>
              <button
      ...
      <section className="relative py-12 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-phantom-gray mb-6">
            For advanced workflows, you can build a custom integration using BetaForge webhooks and the Jira REST API.
          </p>

          <div className="bg-void-elevated border border-white/5 rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-void-black/50">
              <span className="text-sm text-phantom-gray font-mono">jira-sync.js</span>
              <button
            ...
            {[
              {
                ...
                solution: "Check that your API token has 'Create Issues' permission in the target project. Also verify the project key is correct.",
              },
              {
                problem: "Duplicate issues appearing",
                solution: "Enable 'Smart Deduplication' in integration settings. BetaForge uses fuzzy title matching - ensure bug titles are descriptive.",
              },
              {
                problem: "Attachments not uploading",
                solution: "Verify your Jira instance allows attachments and the file size is under the limit (default 10MB). Check API token permissions.",
              },
              {
                problem: "Two-way sync not working",
                solution: "Ensure the Jira webhook is configured to send events to BetaForge. Check Settings → Webhooks for the correct URL.",
              },
              {
                problem: "Custom fields not mapping",
                solution: "Custom field IDs vary per Jira instance. Use the Jira REST API to find your field IDs, then configure them in BetaForge settings.",
              },
            ].map((item) => (
