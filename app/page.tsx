        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <LoginLink className="hidden sm:flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors">
                Login
              </LoginLink>
              <RegisterLink className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-orange-500 text-white font-semibold text-sm transition-all duration-300 hover:bg-orange-600 hover:shadow-lg hover:-translate-y-0.5">
      ...
      <main className="relative pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-16 animate-fade-in-up stagger-4">
            <RegisterLink className="group flex items-center gap-2 px-6 py-3 rounded-full bg-gray-900 text-white font-medium text-sm transition-all duration-300 hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5">
            ...
            <div className="relative flex justify-center items-end gap-4 md:gap-6">
              {AGENTS.map((agent, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative w-full h-full rounded-2xl flex items-center justify-center text-2xl md:text-3xl border-2 border-gray-100 bg-white shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:border-gray-200">
                      {avatars[agent.id]}
                    </div>
          ...
          <section id="features" className="mb-24">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
                Why Teams Choose{" "}
                <span className="text-orange-500">BetaForge</span>
              </h2>
              <p className="text-gray-500 text-base max-w-2xl mx-auto">
                Revolutionary AI testing that thinks, explores, and reports like
                your best QA engineers.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "From cautious explorers to chaos testers, each agent brings a distinct perspective to find bugs others miss.",
                  color: "#8B5CF6",
                },
                {
                  icon: Bug,
                  ...
                  description:
                    "Detailed bug reports with screenshots, reproduction steps, expected vs actual behavior, and severity ratings.",
                  color: "#EF4444",
                },
                {
                  icon: Zap,
                  ...
                  description:
                    "Watch agents work live. See every click, scroll, and discovery as it happens in your dashboard.",
                  color: "#06B6D4",
                },
                {
                  icon: Shield,
                  ...
                  description:
                    "Diego, our chaos tester, actively tries to break your app—finding security holes before bad actors do.",
                  color: "#F97316",
                },
                {
                  icon: Gauge,
                  ...
                  description:
                    "Marcus tests keyboard shortcuts and performance, ensuring your app works for power users too.",
                  color: "#10B981",
                },
                {
                  icon: Sparkles,
                  ...
                  description:
                    "Webhook support for GitHub, GitLab, and Bitbucket. Trigger tests automatically on every push.",
                  color: "#EC4899",
                },
              ].map((feature, index) => (
                <div
          ...
          <section className="relative mb-16">
            <div className="relative bg-gradient-to-r from-orange-50 via-amber-50 to-yellow-50 rounded-2xl p-10 md:p-12 text-center border border-orange-100">
              ...
              <p className="text-gray-500 text-sm max-w-xl mx-auto mb-6">
                Join developers who ship faster with AI-powered beta testing. No
