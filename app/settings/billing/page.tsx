              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span
                      className={`px-2.5 py-1 rounded-full text-xs font-medium capitalize ${getStatusColor(subscription.status)}`}
                    >
                      {subscription.status}
                    </span>
                  </div>
                  <p className="text-phantom-gray">
                    ${subscription.amount}/{subscription.billing_interval === "monthly" ? "month" : "year"}
                ...
                <div className="mt-4 p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-500/80">
                      ...
                      {formatDate(subscription.current_period_end)}. You can reactivate
                      anytime before then.
                    </p>
                  </div>
                </div>
      ...
      <section className="mb-8 p-6 rounded-2xl bg-white/5 border border-white/10 animate-fade-in-up stagger-2">
        ...
        <div className="grid grid-cols-3 gap-4">
          {Object.entries(usage).map(([key, value]) => {
            const percentage = value.limit === -1 ? 0 : (value.used / value.limit) * 100;
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`text-sm font-medium ${isNearLimit ? "text-yellow-500" : "text-white"}`}
                  >
      ...
      {paymentMethod ? (
        ...
        <section className="mb-8 p-6 rounded-2xl bg-white/5 border border-white/10 animate-fade-in-up stagger-3">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-phantom-gray mb-4">No payment method added</p>
        ...
        <div className="fixed inset-0 z-[100]">
          ...
          <div className="relative w-full max-w-md p-6 bg-void-elevated rounded-2xl border border-white/10 pointer-events-auto">
            ...
            <p className="text-phantom-gray mb-6">
              ...
              billing period. Your projects and data will be retained.
            </p>
